...
//        }
        ...
        binding.signUp.setOnClickListener {
            ...
            if(binding.imageUploadSection.text.isNotEmpty() && restaurantName.isNotEmpty() && url.isNotEmpty()&& binding.emailAddress.text.isNotEmpty() && binding.firstname.text.isNotEmpty() && binding.lastname.text.isNotEmpty() && binding.phone.text.isNotEmpty() && binding.password.text.isNotEmpty()){
